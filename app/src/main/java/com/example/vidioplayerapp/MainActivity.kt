package com.example.vidioplayerapp
...
import com.example.vidioplayerapp.ui.theme.VidioPlayerAppTheme
...
fun Player() {
    ...
    val mediaItem =
        MediaItem.fromUri(
            "android.resource://${context.packageName}/${R.raw.mostwickets}"
        )
